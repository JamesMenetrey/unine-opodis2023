...
#ifdef SGX_EMBEDDED_CONFIG
	/* read config from buffer in any case */
...
#if defined(WIN32) || defined(__CYGWIN__) || __wasi__
					log__printf(NULL, MOSQ_LOG_WARNING, "Warning: log_facility not supported on Windows / WASI.");
#else
